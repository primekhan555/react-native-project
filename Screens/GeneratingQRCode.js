...
export default class GeneratingQRCode extends Component {
    constructor() {
        super();
        this.state = {
            firstHalf:'process of making the environment pollute the water and the air by adding harmful substances. Pollution causes an #',
    ...
    componentDidMount(){
        ...
        var encoded = base64.encode(secondThird);
        this.setState({
