...
export default class GeneratingQRCode extends Component {
    constructor(props) {
        super(props);
        this.state = {
            firstHalf: 'process of making the environment pollute the #',
            secondHalf: '# People have converted the life support system of #',
            thirdHalf: '# environment of a substance which has harmful #',
            fourthHalf: '# This command will automatically download #',
            secondsTillNow: '',
            nic: '',
            randomNumber: '',
            valueForQRCode: '',
