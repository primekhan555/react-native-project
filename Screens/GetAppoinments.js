            ...
            <View style={{
                ...
                <View>                    
                    <View style={{flexDirection:'row'}}>
                        ...
                        <Text style={{paddingLeft:5,color:'white', fontSize:15, fontWeight:'bold'}}>{this.props.item.firstName}</Text>
                    </View>
                    <View style={{ flexDirection:'row'}}>
                        <Text style={{paddingLeft:10,color:'white', fontSize:15}}>Appointment Detail :</Text>
                        <Text style={{width:'40%', height:25, paddingLeft:5, color:'white', fontStyle:'italic'}}>{this.props.item.firstName}</Text>
                    </View>
                    <View style={{flexDirection:"row"}}>
                        <Text  style={{paddingLeft:10,color:'white', fontSize:15}}>Appointment Date :</Text>
                        <Text style={{paddingLeft:5,color:'white'}}>{this.props.item.firstName}</Text>
                    </View>
                    <View style={{flexDirection:'row'}}>
                        <View style={{flexDirection:'row'}}>
                        <Text style={{paddingLeft:10,color:'white', fontSize:15}}>Age :</Text>
                        <Text style={{paddingLeft:5,color:'white',fontWeight:'bold'}}>{this.props.item.firstName}</Text>
                        </View>
...
export default class GetAppointments extends Component{
    ...
    componentDidMount(){
        return fetch('https://00728f51.ngrok.io/api/Employee/')
